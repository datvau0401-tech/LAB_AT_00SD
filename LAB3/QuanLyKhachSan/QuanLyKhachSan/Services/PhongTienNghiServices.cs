...
namespace QuanLyKhachSan.Services
{
    public class PhongTienNghiService
    {
        ...
        public KetQuaXuLy ThemTienNghi(
            string ma,
            string loai,
            int stt,
            string tt)
        {
            ...
            {
                return KetQuaXuLy.Fail(
                    "Thông tin tiện nghi không hợp lệ."
                );
            }
            ...
            string ghiChu)
        {
            ...
            {
                return KetQuaXuLy.Fail(
                    "Phiếu lắp đặt chưa đủ thông tin."
                );
            }
            ...
            catch (SqlException ex)
            {
                ...
                {
                    return KetQuaXuLy.Fail(
                        "Thiết bị này đã được lắp cho một phòng khác trong ngày đã chọn."
                    );
                }
