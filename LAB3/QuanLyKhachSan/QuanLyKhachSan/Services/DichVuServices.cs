...
namespace QuanLyKhachSan.Services
{
    public class DichVuService
    {
        ...
        {
            return Db.Query(
                "SELECT p.SoPhieuSDDV, p.SoPhong, p.NgaySuDung, " +
                "d.TenDV, c.SoLuong, c.DonGia, c.ThanhTien " +
            ...
            int soLuong)
        {
            ...
            using (var tx = cn.BeginTransaction())
            {
                try
                {
                    // Kiểm tra phiếu đặt có đang ở hay không
                    ...
                    // Tìm phiếu sử dụng dịch vụ trong ngày
                    ...
                    // Nếu chưa có phiếu sử dụng trong ngày thì tạo mới
                    ...
                    // Kiểm tra dịch vụ đã tồn tại trong phiếu hay chưa
