...
namespace QuanLyKhachSan.Services
{
    public class DanhMucService
    {
            ...
            string sdt)
        {
            ...
            {
                Db.Execute(
                    "INSERT INTO NhanVien VALUES(@m, @t, @v, @s)",
                    new SqlParameter("@m", ma),
                    new SqlParameter("@t", ten),
        ...
        public KetQuaXuLy ThemLoaiTN(string ma, string ten)
        {
            ...
            {
                Db.Execute(
                    "INSERT INTO LoaiTienNghi VALUES(@m, @t)",
                    new SqlParameter("@m", ma),
                    new SqlParameter("@t", ten)
                );
            ...
            decimal gia)
        {
            ...
            {
                Db.Execute(
                    "INSERT INTO DichVu VALUES(@m, @t, @d, @g)",
                    new SqlParameter("@m", ma),
                    new SqlParameter("@t", ten),
            ...
            decimal tien)
        {
            ...
            {
                Db.Execute(
                    "INSERT INTO QuyDinhDenBu VALUES(@m, @l, @u, @t)",
                    new SqlParameter("@m", ma),
