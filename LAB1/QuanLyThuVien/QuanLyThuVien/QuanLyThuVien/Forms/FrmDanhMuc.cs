...
namespace QuanLyThuVien.Forms
{
    public partial class FrmDanhMuc : Form
    {
        ...
        private void dgvNV_SelectionChanged(object sender, EventArgs e)
        {
            ...
            btnNVThem.Enabled = false; btnNVCapNhat.Enabled = true; btnNVXoa.Enabled = true;
        }
        ...
        private void LamMoiNV()
        {
            ...
            btnNVThem.Enabled = true; btnNVCapNhat.Enabled = false; btnNVXoa.Enabled = false;
        }
        ...
        {
            txtTLMa.Clear(); txtTLTen.Clear(); txtTLMa.ReadOnly = false;
            btnTLThem.Enabled = true; btnTLCapNhat.Enabled = false; btnTLXoa.Enabled = false;
        }
        ...
        private void dgvNXB_SelectionChanged(object sender, EventArgs e)
        {
            ...
            btnNXBThem.Enabled = false; btnNXBCapNhat.Enabled = true; btnNXBXoa.Enabled = true;
        }

        private void LamMoiNXB()
        {
            txtNXBMa.Clear(); txtNXBDiaChi.Clear(); txtNXBSDT.Clear(); txtNXBMa.ReadOnly = false;
